    ...
    function singkat($value)
    {
        ...
        foreach ($pecah as $key => $val) {
            if ($key < 3) {
                ...
                $result = $result . strtoupper(substr($val, 0, 1));
            }
        }
        return $result;
    }
...
if (!function_exists('dateexport')) {
    function dateexport($data)
    {
        if ($data == "" || $data == "0000-00-00") {
            return "-";
        } else {
...
if (!function_exists('dateexportinvoice')) {
    function dateexportinvoice($data)
    {
        if ($data == "" || $data == "0000-00-00") {
            return "-";
        } else {
